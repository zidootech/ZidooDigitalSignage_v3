...
public class PiPService extends Service implements HDMIRxListener {
	...
	public boolean play() {
		...
		if (mHDMIRX != null && !mIsPlaying && isPreviewOn) {
	...
	private void createFloatingWindow() {
		...
		wmParams = new WindowManager.LayoutParams(FloatingWindowView.getPIPW(mContext), // 192*3,//WindowManager.LayoutParams.MATCH_PARENT,
				...
				WindowManager.LayoutParams.TYPE_APPLICATION_OVERLAY, flag, PixelFormat.TRANSLUCENT);
